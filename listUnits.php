                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    ...
                                    <ul>
                                         <li>
                                            <a class="mm-active" href="listUnits.php?access_token=<?php echo $_GET['access_token'];?>&user_name=<?php echo $_GET['user_name']; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div id="tableEnlistComponent" class="main-card mb-3 card">
                                    <div class="align-middle card-header">
                                        <h5>Resumen Vehiculos</h5>
                                    </div>
                                    <div id="tableAlistamientos" class="table-responsive">
                                        ...
                                        ?>
                                            ...
                                            <tbody>
                                                <?php 
                                                        foreach($vehiculos as $vehiculo){
                                                            ...
                                                            $nameUnit = $vehiculo['nm'];
                                                            $unitindb = $mysqli->query("SELECT * FROM conductores WHERE nombre = '".$nameUnit."'");
                                                            $rowUnit=mysqli_fetch_array($unitindb);
                                                        ?>
                                                <tr>
                                                <td class="text-center text-muted"><?php echo $vehiculo['id'];?>
                                                </td>
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading"><?php echo $nameUnit;?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <?php
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th class="text-center">No se encontraron vehiculos.</th>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                                <p></p>
