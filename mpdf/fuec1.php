			...
			<table class="width100">
				<tr class="width100">
					<td class="width50 textCenter">
						<img src="http://96.126.106.39/fuec/images/mintransporte.png" alt="" style="width: 3000%;"/>
					</td>
					<td class="width50 textCenter">
						<img src="http://96.126.106.39/fuec/images/logos/'.base64_decode($_POST['id']).'.png" alt="" style="width: 3000%;"/>
					</td>
				</tr>
			</table>
			...
			<table class="width100 marginTop1 textCenter">
				<tr class="width100 textCenter">
					...
					<td class="table-responsive width50 textCenter">
						<img src="../images/firmas/'.base64_decode($_POST['id']).'.png"/>
					</td>
				</tr>
			</table>
		</body>
